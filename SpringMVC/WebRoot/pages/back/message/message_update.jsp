...
<html>
  ...
  <body>
    <form action="pages/back/message/message_update.action" method="post">
    	消息编号:<input type="text" id="mid" name="mid" value="88"> <br>
    	消息名称:<input type="text" id="title" name="title" value="MLDN"> <br>
    	消息价格:<input type="text" id="price" name="price" value="888"> <br>
    	发布日期:<input type="text" id="pubdate" name="pubdate" value="2020-02-22"> <br>
